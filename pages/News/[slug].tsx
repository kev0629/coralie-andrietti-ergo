      ...
      <Section title={article.title}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose lg:prose-xl max-w-none mx-auto">
            <p>
              Le contenu de l&apos;article pour &quot;{article.title}&quot; sera
              affiché ici.
            </p>
            <p>
              Pour l&apos;instant, les anciennes pages comme{" "}
              <code>{article.slug}.jsx</code> sont toujours utilisées. Il faudra
              migrer leur contenu ici.
            </p>
          </div>
