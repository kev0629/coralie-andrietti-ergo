...
export default function Les_troubles_neuro_visuels() {
    ...
    return (
        <Body>
            ...
            <br/> 
            <Image width={16} height={16} src={arrow}/> En bilan, l’ergothérapeute va, par exemple, vérifier que l’enfant (selon l’âge) peut suivre un objet en mouvement devant ses yeux, qu’il peut passer d’un objet à un autre avec son regard… 
            <ul>
            ...
            <Image width={16} height={16} src={arrow}/> En bilan, l’ergothérapeute va , par exemple, demander à l’enfant  (selon l’âge) de reconnaître des formes et de les désigner, de retrouver des formes géométriques parmi plusieurs figures enchevêtrées …
            <ul>
            ...
            <br/>
            <Image width={16} height={16} src={arrow}/> En bilan, l’ergothérapeute va, par exemple, demander à l’enfant (selon l’âge) de situer des éléments visuels les uns par rapport aux autres, vérifier les notions de rotation mentale … <br/>
            <br/>
            ...
            <br/>
            <Image width={16} height={16} src={arrow}/> En bilan, l’ergothérapeute va, par exemple, demander à l’enfant (selon l’âge) de réaliser un tracé sans dépasser avec un stylo, d’enfiler une perle …
            <ul>
            ...
            <br/>
            <Image width={16} height={16} src={arrow}/> En bilan, l’ergothérapeute va, par exemple, demander à l’enfant (selon l’âge), de recopier une figure complexe depuis un modèle, de construire des figures avec des cubes … <br/>
            <br/>
            ...
            Que faire ?<br/>
            <br/>
            Si vous avez l’impression de repérer des difficultés chez votre enfant, parlez-en à votre médecin. Le médecin orientera vers le professionnel de santé le plus adapté aux difficultés de votre enfant.<br/>
            <br/>
            <div className='note'>
                Sources :<br/>
