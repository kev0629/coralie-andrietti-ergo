    ...
    <Body>
      <Section title={article.title}>
        ...
        <p className="flex justify-center my-4">
          ...
          jusqu’à des comportements difficiles comme : être agressif envers moi
          ou eux-mêmes, ignorer les consignes, bouder, pleurer, se replier sur
          eux-mêmes …
        </p>
        <br />
        ...
        <p>
          Et bien oui ! Dans la majorité des cas les comportements difficiles
        ...
        <div className="g1-03">
          <div>
            ...
            <p>
              <Image width={16} height={16} alt="arrow" src={arrow} />
              {
                "Au cours du bilan, il a été décelé que Sarah-Lou avait des difficultés de motricité fine. Du coup, toutes les activités qui nécessitaient de la motricité fine étaient, en fait, difficiles pour elle.  C’est probablement pour cela qu’elle « rechignait » à les faire que ce soit à la maison ou à l'école. "
              }
            </p>
          </div>
          <div className="flex justify-center my-4">
        ...
        <p style={{ textIndent: 25 }}>
          ...
          {"chose qui ne va pas pour lui : "}
          <b>
            {"il y a toujours une raison derrière le comportement de l'enfant."}
          </b>
        </p>
        <p style={{ textIndent: 25 }}>
          {
