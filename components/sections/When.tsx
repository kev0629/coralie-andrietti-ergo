      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <AccordionItem title="Chez l’enfant">
          <p className="mb-2 font-semibold">
            Dès l’apparition de difficultés dans :
          </p>
          <ul className="list-disc list-inside pl-4 space-y-2">
            ...
            <li>
              Le comportement ludique, d’exploration et les interactions (peu
            ...
            <li>
              Les apprentissages scolaires et préscolaires (graphisme,
              utilisation des outils, géométrie…).
            </li>
          </ul>
        </AccordionItem>
        ...
        <AccordionItem title="Chez l’adulte et la personne âgée">
          <p className="mb-2 font-semibold">
            En cas de difficultés dans les activités quotidiennes liées à :
          </p>
          <ul className="list-disc list-inside pl-4 space-y-2">
          ...
          <ul className="list-disc list-inside pl-4 space-y-2">
            ...
            <li>
              Les activités productives (aller au travail, être bien positionné
              à son bureau, accomplir sa journée de travail…).
            </li>
            <li>Les activités de loisirs.</li>
            <li>
              L’aménagement du domicile (entrer dans la baignoire, se relever
              des toilettes…).
            </li>
            <li>
              Tenir son rôle social (s’occuper d’un proche, écrire une lettre,
              etc.).
            </li>
          </ul>
        </AccordionItem>
